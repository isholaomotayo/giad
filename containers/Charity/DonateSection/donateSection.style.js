...
export const Heading = styled.h2`
  ...
  span {
    color: ${themeGet('color.primary', '#0071bc')};
  }
`;
...
export const ButtonGroup = styled.div`
  ...
  .learn__more-btn {
    color: ${themeGet('color.primary', '#0071bc')} !important;
    ...
    .hyphen {
      background-color: ${themeGet('color.primary', '#0071bc')}!important;
    }
...
export const DonationForm = styled.form`
  ...
  .radio_group {
    ...
    label {
      ...
      &.active {
        border-color: ${themeGet('colors.primary', '#0071bc')};
        background-color: ${themeGet('colors.primary', '#0071bc')};
      }
...
export const DonateButton = styled.button`
  ...
  cursor: pointer;
  color: ${themeGet('colors.white', '#ffffff')};
  background-color: ${themeGet('colors.secondary', '#0071bc')};
  position: relative;
  overflow: hidden;
  z-index: 1;
  margin-top: 50px;
  ...
  &::before {
    ...
    background: repeating-linear-gradient(
      -45deg,
      ${themeGet('colors.secondary', '#0071bc')},
      ${themeGet('colors.secondary', '#0071bc')} 10px,
    ...
    @media only screen and (max-width: 1440px) {
      background: repeating-linear-gradient(
        -45deg,
        ${themeGet('colors.secondary', '#0071bc')},
        ${themeGet('colors.secondary', '#0071bc')} 8px,
